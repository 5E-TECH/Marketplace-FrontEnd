...
interface TariffValues { tariffHome: number; tariffCenter: number }
...
export default function AdminShopsPage() {
  ...
  const feature = useSetAdminShopFeaturedMutation();
  const tariffs = useUpdateAdminShopTariffsMutation();
