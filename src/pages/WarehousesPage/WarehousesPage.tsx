...
export default function WarehousesPage() {
  ...
  if (warehousesQuery.isError) return <ContentState state="error" title="Omborlarni yuklab bo‘lmadi" description={getApiErrorMessage(warehousesQuery.error)} onAction={() => void warehousesQuery.refetch()} />;
