...
const financeKeys = { all: ['admin-finance'] as const, payouts: (params: PayoutListParams) => [...financeKeys.all, 'payouts', params] as const, report: (kind: string, params: ReportParams) => [...financeKeys.all, kind, params] as const };
